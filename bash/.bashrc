...
alias yta='/usr/bin/youtube-dl -xc --audio-format mp3'
# YouTube: Download Playlist as MP3
alias ytapl='/usr/bin/youtube-dl -citx --audio-format mp3'
# YouTube: Download Video
alias ytv='/usr/bin/youtube-dl'
#YouTube: Download Video Playlist
alias ytvpl='/usr/bin/youtube-dl -cit'

alias showiso="identify -verbose $1"
